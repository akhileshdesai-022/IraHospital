  ...
  return (
    <div className='flex items-center justify-between py-4 mb-5 text-sm border-b border-b-gray-400'>
        ...
        <div className='flex items-center gap-4'>
            ...
            {/* mobile menu */}
            <div  className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 bottom-0 top-0 z-20 overflow-hidden bg-white transall-all`}>
              ...
              <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
               ...
               <NavLink  onClick={()=>showMenu(false)} to='/doctor'><p className='px-4 py-2 rounded inline-block'>ALL DOCTORS</p></NavLink>
